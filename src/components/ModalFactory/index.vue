<template>
  <teleport to="body">
    <div
    v-if="state.isActive"
    @click="handleModalToggle({status: false})" class="fixed top-0 left-0 z-50 flex items-center justify-center w-full h-full bg-black bg-opacity-50">
...
<script>
import { onBeforeMount, onBeforeUnmount, onMounted, reactive, defineAsyncComponent } from 'vue'
